...
proto.dstore.engine.co_GetCommunityStatistics_Pu.Parameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    listOfStatisticInformationIdsNull: jspb.Message.getFieldWithDefault(msg, 1004, false),
 ...
 */
proto.dstore.engine.co_GetCommunityStatistics_Pu.Response.prototype.addMetaInformation = function(opt_value, opt_index) {
 ...
 */
proto.dstore.engine.co_GetCommunityStatistics_Pu.Response.prototype.addMessage = function(opt_value, opt_index) {
...
/**
 * @param {!proto.dstore.engine.co_GetCommunityStatistics_Pu.Response.Row=} opt_value
 * @param {number=} opt_index
 * @return {!proto.dstore.engine.co_GetCommunityStatistics_Pu.Response.Row}
 */
proto.dstore.engine.co_GetCommunityStatistics_Pu.Response.prototype.addRow = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.dstore.engine.co_GetCommunityStatistics_Pu.Response.Row, opt_index);
};
