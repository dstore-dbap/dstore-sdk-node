...
goog.exportSymbol('proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response', null, global);
goog.exportSymbol('proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row', null, global);
 ...
 * @constructor
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.displayName = 'proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * @return {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters;
  return proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = new dstore_values_pb.booleanValue;
      reader.readMessage(value,dstore_values_pb.booleanValue.deserializeBinaryFromReader);
      msg.setOrderByLoginTime(value);
      break;
    case 1002:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setOrderByLoginTimeNull(value);
      break;
    case 3:
    ...
    case 11:
      var value = new dstore_values_pb.integerValue;
      reader.readMessage(value,dstore_values_pb.integerValue.deserializeBinaryFromReader);
      msg.setFilterByOnlineStatus(value);
      break;
    case 1011:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setFilterByOnlineStatusNull(value);
      break;
    case 12:
      var value = new dstore_values_pb.booleanValue;
      reader.readMessage(value,dstore_values_pb.booleanValue.deserializeBinaryFromReader);
 ...
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.serializeBinaryToWriter = function(message, writer) {
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.serializeBinary = function() {
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  ...
  f = this.getOrderByLoginTimeNull();
  if (f) {
    writer.writeBool(
      1002,
      f
  ...
  f = this.getFilterByOnlineStatus();
  if (f != null) {
    writer.writeMessage(
      11,
      f,
  ...
  f = this.getFilterByOnlineStatusNull();
  if (f) {
    writer.writeBool(
      1011,
      f
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearDescending = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearOrderByLoginTime = function() {
  this.setOrderByLoginTime(undefined);
};
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearUniqueId = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearPersonIdentificationValues = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearCommunityId = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearOnlineTimeDuringLastXMinutes = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearOutputCharacteristicId1 = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearOutputCharacteristicId2 = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearOutputCharacteristicId3 = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearCommunityBinaryCategoryId = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearFilterByOnlineStatus = function() {
  this.setFilterByOnlineStatus(undefined);
};
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearOutputIntoOneId = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Parameters.prototype.clearSeparatorInIdentVals = function() {
 ...
 * @constructor
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.repeatedFields_, null);
};
goog.inherits(proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.displayName = 'proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response';
}
/**
 ...
 * @const
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.repeatedFields_ = [2,3,4];
 ...
 * @return {!Object}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response} msg The msg instance to transform.
 * @return {!Object}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response;
  return proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.getMetaInformationList = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.clearMetaInformationList = function() {
 ...
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.getMessageList = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.clearMessageList = function() {
  this.setMessageList([]);
};
 ...
 * If you change this array by adding, removing or replacing elements, or if you
 * replace the array itself, then you must call the setter to update it.
 * @return {!Array.<!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row>}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.getRowList = function() {
  return /** @type{!Array.<!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row, 4));
};
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.prototype.clearRowList = function() {
  this.setRowList([]);
};
 ...
 * @constructor
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.displayName = 'proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row;
  return proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getRowId();
  if (f !== 0) {
    writer.writeInt32(
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearValue1RestrictedByPattern = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearBinaryId = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearOnlineTimeInSeconds = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearValue2RestrictedByPattern = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearCommunityMemberId = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearValue3 = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearOnlineStatus = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearValue1 = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearValue2 = function() {
...
proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu.Response.Row.prototype.clearValue3RestrictedByPattern = function() {
...
goog.object.extend(exports, proto.dstore.engine.co_GetCurrentlyUsersOnline_Pu);
