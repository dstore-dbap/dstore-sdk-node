 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Parameters.prototype.hasProcedureName = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Parameters.prototype.hasProcedureResultConditionId = function() {
 ...
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.prototype.addMetaInformation = function(opt_value, opt_index) {
 ...
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.prototype.addMessage = function(opt_value, opt_index) {
...
/** @param {!Array.<!proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row>} value */
...
/**
 * @param {!proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row=} opt_value
 * @param {number=} opt_index
 * @return {!proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.prototype.addRow = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row, opt_index);
};
 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row.prototype.hasConditionDescription = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row.prototype.hasCondition = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row.prototype.hasProcedureResultConditionId = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row.prototype.hasProcedureName = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.do_GetProcResultConditions_Ad.Response.Row.prototype.hasParameterName = function() {
