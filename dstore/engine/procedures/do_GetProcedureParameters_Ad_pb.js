 ...
 * @constructor
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.displayName = 'proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * @return {!proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters;
  return proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1003:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setFilterRowsWithEmptyDescrNull(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.serializeBinaryToWriter = function(message, writer) {
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.prototype.serializeBinary = function() {
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  ...
  f = this.getFilterRowsWithEmptyDescr();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.prototype.clearProcedureName = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.prototype.clearParameterNameLike = function() {
  this.setParameterNameLike(undefined);
};
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Parameters.prototype.clearFilterRowsWithEmptyDescr = function() {
  this.setFilterRowsWithEmptyDescr(undefined);
};
 ...
 * @constructor
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dstore.engine.do_GetProcedureParameters_Ad.Response.repeatedFields_, null);
};
goog.inherits(proto.dstore.engine.do_GetProcedureParameters_Ad.Response, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.do_GetProcedureParameters_Ad.Response.displayName = 'proto.dstore.engine.do_GetProcedureParameters_Ad.Response';
}
/**
 ...
 * @const
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.repeatedFields_ = [2,3,4];
 ...
 * @return {!Object}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.do_GetProcedureParameters_Ad.Response.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.do_GetProcedureParameters_Ad.Response;
  return proto.dstore.engine.do_GetProcedureParameters_Ad.Response.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getError();
  if (f != null) {
    writer.writeMessage(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.getError = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.setError = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.clearError = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.clearMetaInformationList = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.clearMessageList = function() {
  this.setMessageList([]);
};
 ...
 * If you change this array by adding, removing or replacing elements, or if you
 * replace the array itself, then you must call the setter to update it.
 * @return {!Array.<!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row>}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.getRowList = function() {
  return /** @type{!Array.<!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row, 4));
};


/** @param {Array.<!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row>|undefined} value  */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.setRowList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 4, value);
};


proto.dstore.engine.do_GetProcedureParameters_Ad.Response.prototype.clearRowList = function() {
  this.setRowList([]);
};
 ...
 * @constructor
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.displayName = 'proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row;
  return proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getRowId();
  if (f !== 0) {
    writer.writeInt32(
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearIsOutputParameter = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearDescriptionValidSinceVersion = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearDescription = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearPrecisionValue = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearParameterName = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearScale = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearSortNo = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearDefaultValue = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearLength = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearDescriptionLastEdited = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearProcedureName = function() {
  this.setProcedureName(undefined);
};
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearIntroducedIndstoreVersion = function() {
...
proto.dstore.engine.do_GetProcedureParameters_Ad.Response.Row.prototype.clearDataType = function() {
  this.setDataType(undefined);
};


goog.object.extend(exports, proto.dstore.engine.do_GetProcedureParameters_Ad);
