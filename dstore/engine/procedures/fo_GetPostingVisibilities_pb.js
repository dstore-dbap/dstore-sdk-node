...
proto.dstore.engine.fo_GetPostingVisibilities.Parameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    visibleNull: jspb.Message.getFieldWithDefault(msg, 1001, false),
    visibleGet: (f = msg.getVisibleGet()) && dstore_values_pb.integerValue.toObject(includeInstance, f),
    visibleGetNull: jspb.Message.getFieldWithDefault(msg, 1002, false)
  };
 ...
 * @return {!boolean}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Parameters.prototype.hasVisible = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Parameters.prototype.hasVisibleGet = function() {
 ...
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.prototype.addMetaInformation = function(opt_value, opt_index) {
 ...
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.prototype.addMessage = function(opt_value, opt_index) {
...
/** @param {!Array.<!proto.dstore.engine.fo_GetPostingVisibilities.Response.Row>} value */
...
/**
 * @param {!proto.dstore.engine.fo_GetPostingVisibilities.Response.Row=} opt_value
 * @param {number=} opt_index
 * @return {!proto.dstore.engine.fo_GetPostingVisibilities.Response.Row}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.prototype.addRow = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.dstore.engine.fo_GetPostingVisibilities.Response.Row, opt_index);
};
 ...
 * @return {!boolean}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.Row.prototype.hasDescription = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.Row.prototype.hasVisible = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.Row.prototype.hasVisibility = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.fo_GetPostingVisibilities.Response.Row.prototype.hasVisibleGet = function() {
