 ...
 * @constructor
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.im_GetItemConditions_Ad.Parameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.im_GetItemConditions_Ad.Parameters.displayName = 'proto.dstore.engine.im_GetItemConditions_Ad.Parameters';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.im_GetItemConditions_Ad.Parameters.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Parameters} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * @return {!proto.dstore.engine.im_GetItemConditions_Ad.Parameters}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.im_GetItemConditions_Ad.Parameters;
  return proto.dstore.engine.im_GetItemConditions_Ad.Parameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Parameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.im_GetItemConditions_Ad.Parameters}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Parameters} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.serializeBinaryToWriter = function(message, writer) {
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.serializeBinary = function() {
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  ...
  f = this.getConditionDescriptionLike();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
...
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.clearConditionId = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.clearConditionDescriptionLike = function() {
  this.setConditionDescriptionLike(undefined);
};
...
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.clearGetUnusedConditions = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.clearOrderBy = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Parameters.prototype.clearRowCount = function() {
 ...
 * @constructor
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dstore.engine.im_GetItemConditions_Ad.Response.repeatedFields_, null);
};
goog.inherits(proto.dstore.engine.im_GetItemConditions_Ad.Response, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.im_GetItemConditions_Ad.Response.displayName = 'proto.dstore.engine.im_GetItemConditions_Ad.Response';
}
/**
 ...
 * @const
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.repeatedFields_ = [2,3,4];
 ...
 * @return {!Object}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.im_GetItemConditions_Ad.Response.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Response} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dstore.engine.im_GetItemConditions_Ad.Response}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.im_GetItemConditions_Ad.Response;
  return proto.dstore.engine.im_GetItemConditions_Ad.Response.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Response} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.im_GetItemConditions_Ad.Response}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Response} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getError();
  if (f != null) {
    writer.writeMessage(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.getError = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.setError = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.clearError = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.clearMetaInformationList = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.clearMessageList = function() {
  this.setMessageList([]);
};
 ...
 * If you change this array by adding, removing or replacing elements, or if you
 * replace the array itself, then you must call the setter to update it.
 * @return {!Array.<!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row>}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.getRowList = function() {
  return /** @type{!Array.<!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dstore.engine.im_GetItemConditions_Ad.Response.Row, 4));
};


/** @param {Array.<!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row>|undefined} value  */
proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.setRowList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 4, value);
};


proto.dstore.engine.im_GetItemConditions_Ad.Response.prototype.clearRowList = function() {
  this.setRowList([]);
};
 ...
 * @constructor
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.im_GetItemConditions_Ad.Response.Row, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.displayName = 'proto.dstore.engine.im_GetItemConditions_Ad.Response.Row';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.im_GetItemConditions_Ad.Response.Row;
  return proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.im_GetItemConditions_Ad.Response.Row} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getRowId();
  if (f !== 0) {
    writer.writeInt32(
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearConditionDescription = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearOperator1 = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearCondition1 = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearCondition2 = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearOperator2 = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearConditionGroupDescription = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearCombinePartsWithANDOperator = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearRecursiveEvaluation = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearConditionPartId = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearDomainTreeNodeIds = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearNodeCharacteristicId = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearCreatedAtDateAndTime = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearCombineGroupsWithANDOperator = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearUsedAsCampaignBenefitCondition = function() {
  this.setUsedAsCampaignBenefitCondition(undefined);
};
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearConditionGroupId = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearLevelIds = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearEditedAtDateAndTime = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearUsedAsCampaignCondition = function() {
  this.setUsedAsCampaignCondition(undefined);
};
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearGroupSortNo = function() {
  this.setGroupSortNo(undefined);
};
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearPartSortNo = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearIsValid = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearConditionPartDescription = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearInheritDepth = function() {
...
proto.dstore.engine.im_GetItemConditions_Ad.Response.Row.prototype.clearConditionId = function() {
  this.setConditionId(undefined);
};


goog.object.extend(exports, proto.dstore.engine.im_GetItemConditions_Ad);
