 ...
 * @return {!boolean}
 */
proto.dstore.engine.mi_GetRegions.Parameters.prototype.hasRegionId = function() {
 ...
 */
proto.dstore.engine.mi_GetRegions.Response.prototype.addMetaInformation = function(opt_value, opt_index) {
 ...
 */
proto.dstore.engine.mi_GetRegions.Response.prototype.addMessage = function(opt_value, opt_index) {
...
/** @param {!Array.<!proto.dstore.engine.mi_GetRegions.Response.Row>} value */
...
/**
 * @param {!proto.dstore.engine.mi_GetRegions.Response.Row=} opt_value
 * @param {number=} opt_index
 * @return {!proto.dstore.engine.mi_GetRegions.Response.Row}
 */
proto.dstore.engine.mi_GetRegions.Response.prototype.addRow = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.dstore.engine.mi_GetRegions.Response.Row, opt_index);
};
 ...
 * @return {!boolean}
 */
proto.dstore.engine.mi_GetRegions.Response.Row.prototype.hasRegion = function() {
 ...
 * @return {!boolean}
 */
proto.dstore.engine.mi_GetRegions.Response.Row.prototype.hasRegionId = function() {
