 ...
 * @constructor
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.om_ChangeOrderState_Ad.Parameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.displayName = 'proto.dstore.engine.om_ChangeOrderState_Ad.Parameters';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Parameters} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * @return {!proto.dstore.engine.om_ChangeOrderState_Ad.Parameters}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.om_ChangeOrderState_Ad.Parameters;
  return proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Parameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.om_ChangeOrderState_Ad.Parameters}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Parameters} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.serializeBinaryToWriter = function(message, writer) {
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.serializeBinary = function() {
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getFireacChangeOrderState();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearFireacChangeOrderState = function() {
  this.setFireacChangeOrderState(undefined);
};
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearResult = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearOrderContentIds = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearIsOrderId = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearOrderStateId = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearAcceptNegativeStock = function() {
  this.setAcceptNegativeStock(undefined);
};
...
proto.dstore.engine.om_ChangeOrderState_Ad.Parameters.prototype.clearSelectDeniedOrders = function() {
 ...
 * @constructor
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dstore.engine.om_ChangeOrderState_Ad.Response.repeatedFields_, null);
};
goog.inherits(proto.dstore.engine.om_ChangeOrderState_Ad.Response, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.om_ChangeOrderState_Ad.Response.displayName = 'proto.dstore.engine.om_ChangeOrderState_Ad.Response';
}
/**
 ...
 * @const
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.repeatedFields_ = [2,3,4];
 ...
 * @return {!Object}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.om_ChangeOrderState_Ad.Response.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Response} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dstore.engine.om_ChangeOrderState_Ad.Response}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.om_ChangeOrderState_Ad.Response;
  return proto.dstore.engine.om_ChangeOrderState_Ad.Response.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Response} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.om_ChangeOrderState_Ad.Response}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Response} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getError();
  if (f != null) {
    writer.writeMessage(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.getError = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.setError = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.clearError = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.clearMetaInformationList = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.clearMessageList = function() {
  this.setMessageList([]);
};
 ...
 * If you change this array by adding, removing or replacing elements, or if you
 * replace the array itself, then you must call the setter to update it.
 * @return {!Array.<!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row>}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.getRowList = function() {
  return /** @type{!Array.<!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row, 4));
};


/** @param {Array.<!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row>|undefined} value  */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.setRowList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 4, value);
};


proto.dstore.engine.om_ChangeOrderState_Ad.Response.prototype.clearRowList = function() {
  this.setRowList([]);
};
 ...
 * @constructor
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.displayName = 'proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row';
}
 ...
 * @return {!Object}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.prototype.toObject = function(opt_includeInstance) {
  return proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row} msg The msg instance to transform.
 * @return {!Object}
 */
 ...
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row;
  return proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getRowId();
  if (f !== 0) {
    writer.writeInt32(
...
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.prototype.clearOrderId = function() {
...
proto.dstore.engine.om_ChangeOrderState_Ad.Response.Row.prototype.clearOrderContentId = function() {
  this.setOrderContentId(undefined);
};


goog.object.extend(exports, proto.dstore.engine.om_ChangeOrderState_Ad);
