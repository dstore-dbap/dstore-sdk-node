...
proto.dstore.engine.om_GetCashAccTransactions_Pu.Parameters.prototype.clearAccountBalance = function() {
...
/**
 * optional bool account_balance_null = 1006;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
...
/**
 * optional bool only_transactions_since_null = 1007;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
