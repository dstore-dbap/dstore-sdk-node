...
proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Parameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    deleteSurchargeNull: jspb.Message.getFieldWithDefault(msg, 1004, false)
  };
 ...
 */
proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Response.prototype.addMetaInformation = function(opt_value, opt_index) {
 ...
 */
proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Response.prototype.addMessage = function(opt_value, opt_index) {
...
/**
 * @param {!proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Response.Row=} opt_value
 * @param {number=} opt_index
 * @return {!proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Response.Row}
 */
proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Response.prototype.addRow = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.dstore.engine.om_ModifyVoucherTypeSurch_Ad.Response.Row, opt_index);
};
